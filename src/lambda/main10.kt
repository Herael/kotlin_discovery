...
fun main(args: Array<String>) {
    ...
    println(users.maxUser { it.experience }) // => User(email=toto@gmail.com, age=20, experience=2000)
    println(users.maxUser { it.age }) // => User(email=oc@gmail.com, age=35, experience=1000)
}